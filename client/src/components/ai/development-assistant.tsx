  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      id: '1',
      role: 'assistant',
      content: 'Hello! I\'m your NeoCore AI development assistant powered by OpenAI GPT-4o-mini. I can help you with:\n\n• Writing database schemas and queries\n• Generating API endpoints\n• Creating serverless functions\n• Optimizing performance\n• Security best practices\n\nWhat would you like to build today?',
      timestamp: new Date(),
      type: 'normal'
    }
  ]);
              ...
              <div className="flex justify-start">
                <div className="bg-purple-600/20 text-purple-100 p-3 rounded-lg">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm">OpenAI GPT-4o-mini is thinking...</span>
                  </div>
                </div>
              </div>
            )}
